...
from lab3.inversion import inverse_matrix
...
if __name__ == '__main__':
    ...
    print('\nAFTER INVERSION:')
    Ai = inverse_matrix(A)
    print("My:", norm(Ai, 1), ", library:", np.linalg.norm(Ai, ord=1))
    print("My:", norm(Ai, 2), ", library:", np.linalg.norm(Ai, ord=2))
    print("My:", norm(Ai, "inf"), ", library:", np.linalg.norm(Ai, ord=np.inf))